...
public class NemoTest {
  ...
  @Test public void test00CheckInitialNemoCoordinates() {
	...
	assertEquals( new SurfaceLevel0(), new Nemo(new Position(0,0),new West()).getSurfaceLevel() );
  }
  ...
  @Test public void test03NemoGoesDown() {
	assertEquals(new SurfaceLevel1(),new Nemo(new Position(2, 1), new West()).Command("d").getSurfaceLevel());  
  }
  ...
  @Test public void test05AcceptsSeveralDownCommands() {
	assertEquals(new SurfaceLevelDepths(new SurfaceLevel1()),new Nemo(new Position(3, 1),  new West()).Command("dd").getSurfaceLevel());
  }

  @Test public void test06GoingUpInSurfaceZeroStaysInSurfaceZero() {
	assertEquals(new SurfaceLevel0(), new Nemo(new Position(0, 0),new West()).Command("uuuuuu").getSurfaceLevel());
  }
  ...
  @Test public void test16ThrowingCaosulaDoesNotAffectSubmarine() {
	...
	assertEquals(nemo.getSurfaceLevel(), new SurfaceLevel0());
  }
  ...
  @Test public void test18MoveUpWorksCorrectly() {
	Nemo nemo = new Nemo(new Position(3,1),new West());
	nemo.Command("ddddd");
	nemo.Command("uuuu");
	assertEquals(new SurfaceLevel1(), nemo.getSurfaceLevel());
  }
